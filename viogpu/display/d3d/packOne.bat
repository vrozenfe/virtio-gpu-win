...
set DLL_PATH_AND_NAME=objfre_%INST_OS%_%INST_ARC%\%EXT_ARC%\%FILE_NAME%.dll
...
echo %DLL_PATH_AND_NAME%
echo %PDB_PATH_AND_NAME%

copy /Y %DLL_PATH_AND_NAME% ..\..\Install\%INST_OS%\%INST_ARC%
copy /Y %PDB_PATH_AND_NAME% ..\..\Install\%INST_OS%\%INST_ARC%

set INST_OS=
set INST_ARC=
set FILE_NAME=
set DLL_PATH_AND_NAME=
