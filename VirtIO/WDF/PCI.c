                      ...
                      PVIRTIO_WDF_DRIVER pWdfDriver)
{
    ...
    DPrintf(0, ("%s Interrupts %d, MSIInterrupts %d\n", __FUNCTION__, nInterrupts, nMSIInterrupts));
...
{
    ULONG read;
    DPrintf(0, ("%s where %d, length %d\n", __FUNCTION__, where, (int)length));
